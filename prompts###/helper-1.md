...
You must evaluate all package selections, kernel modules, drivers, and configurations against this exact hardware snapshot. Do not suggest solutions meant for generic setups:
- OS & Kernel: Arch Linux (7.0.9-zen1-1-zen kernel)
- init System: systemd
- CPU: Intel Core i5-14400F
- GPU & Drivers: NVIDIA Corporation GB206 [GeForce RTX 5060], proprietary NVIDIA drivers (v595.71.05), running X.org / Xwayland
- Memory & Swap: 16 GiB RAM with a 15.4 GiB zram0 disk configured as SWAP
- Storage Partitioning:
  * nvme0n1 (931.5 GiB) mounted entirely at /mnt
  * nvme1n1 (931.5 GiB) partitioned into: /boot (1 GiB UEFI), / (150 GiB root), /home (780.5 GiB)
- Network: Intel Ethernet I219-V & Intel Dual Band Wireless-AC 3168NGW (iwlwifi driver)
- Package Managers: pacman (Official Repos), yay/paru (AUR)
